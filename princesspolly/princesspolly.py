...
class PrincessPolly:
    ...
    def crawl_detail(self,url) -> dict or str:
        try:
            ...
            imgs = "|".join(["https"+i for i in tree.xpath('//div[@class="product__zoom"]/@data-product-detail-zoom')])
            return {"imgs":imgs}
    ...
    def crawl_link(self,query,row) -> None:
        ...
        api_url = "https://ultimate-dot-acp-magento.appspot.com/full_text_search?q={}&page_num={}&store_id={}&UUID={}&cdn_cache_key=1650973928&facets_required=1&callback=ispSearchResult&related_search=1&with_product_attributes=1"
        ...
        for i in tqdm(range(1,total_page+1)):
            ...
            for product in tqdm(js['items']):
                ...
                product_url = "https://us.princesspolly.com"+product['u']
